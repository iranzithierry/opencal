...
const myIdElement = document.getElementById("myID") as HTMLElement;
const userTableBody = document.getElementById("userListBody") as HTMLTableElement;
const ongoingCallSection = document.getElementById("ongoingCallSection") as HTMLElement;
const callStatusElement = document.getElementById("callStatus") as HTMLElement;
const hangUpButton = document.getElementById("hangUpButton") as HTMLElement;
...
socket.on("update-dashboard-users", (users) => {
  ...
  if (callOngoing) {
    document.querySelectorAll(".call-btn").forEach((btn: any) => (btn.disabled = true));
  }
});
